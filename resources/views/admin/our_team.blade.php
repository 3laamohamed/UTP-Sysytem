      ...
      <table class="table mt-4 text-center shadow-lg" style="font-size: 1rem;">
        ...
        <tbody class="table-light">
          ...
          <tr id="{{$person->id}}">
            ...
            <td>{{$person->name}}</td>
            <td>
              <button class="table-buttons" onclick="getRow({{$person->id}})">
