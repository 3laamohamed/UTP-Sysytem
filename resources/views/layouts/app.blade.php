        ...
        <main>
          ...
          <aside>
            ...
            <ul class="">
              ...
              @can('group_services')<li class="@if(Route::current()->getName() == 'admin.View_sort_group_services') active @endif"><a href="{{Route('admin.View_sort_group_services')}}"><i class="fa-solid fa-shuffle fa-xl"></i> <span>sort group</span> </a></li>@endcan
              ...
              @can('sort_services')<li class="@if(Route::current()->getName() == 'admin.View_sort_services') active @endif"><a href="{{Route('admin.View_sort_services')}}"><i class="fa-solid fa-shuffle fa-xl"></i> <span>sort services</span> </a></li>@endcan
